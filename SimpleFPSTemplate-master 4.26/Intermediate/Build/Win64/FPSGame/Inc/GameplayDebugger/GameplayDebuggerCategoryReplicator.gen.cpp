...
static struct FScriptStruct_GameplayDebugger_StaticRegisterNativesFGameplayDebuggerVisLogSync
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("GameplayDebuggerVisLogSync")),new UScriptStruct::TCppStructOps<FGameplayDebuggerVisLogSync>);
	}
...
static struct FScriptStruct_GameplayDebugger_StaticRegisterNativesFGameplayDebuggerNetPack
{
	...
	IMPLEMENT_CLASS(AGameplayDebuggerCategoryReplicator, 814606908);
