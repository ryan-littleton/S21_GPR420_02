...
static struct FScriptStruct_FunctionalTesting_StaticRegisterNativesFAITestSpawnSet
{
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAITestSpawnSet_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAITestSpawnSet, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FAITestSpawnSet_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAITestSpawnSet_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FAITestSpawnSet_Statics::NewProp_FallbackSpawnLocation = { "FallbackSpawnLocation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAITestSpawnSet, FallbackSpawnLocation), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAITestSpawnSet_Statics::NewProp_FallbackSpawnLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAITestSpawnSet_Statics::NewProp_FallbackSpawnLocation_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAITestSpawnSet_Hash() { return 1383943440U; }

static_assert(std::is_polymorphic<FPendingDelayedSpawn>() == std::is_polymorphic<FAITestSpawnInfo>(), "USTRUCT FPendingDelayedSpawn cannot be polymorphic unless super FAITestSpawnInfo is polymorphic");
...
static struct FScriptStruct_FunctionalTesting_StaticRegisterNativesFPendingDelayedSpawn
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FPendingDelayedSpawn_Hash() { return 2553166453U; }
...
static struct FScriptStruct_FunctionalTesting_StaticRegisterNativesFAITestSpawnInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAITestSpawnInfo_Hash() { return 1995429780U; }
	DEFINE_FUNCTION(AFunctionalAITest::execIsOneOfSpawnedPawns)
	{
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFunctionalAITest_IsOneOfSpawnedPawns_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFunctionalAITest, nullptr, "IsOneOfSpawnedPawns", nullptr, nullptr, sizeof(FunctionalAITest_eventIsOneOfSpawnedPawns_Parms), Z_Construct_UFunction_AFunctionalAITest_IsOneOfSpawnedPawns_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFunctionalAITest_IsOneOfSpawnedPawns_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFunctionalAITest_IsOneOfSpawnedPawns_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFunctionalAITest_IsOneOfSpawnedPawns_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFunctionalAITest_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFunctionalAITest_IsOneOfSpawnedPawns, "IsOneOfSpawnedPawns" }, // 2995167921
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_SpawnedPawns = { "SpawnedPawns", nullptr, (EPropertyFlags)0x0020080000000014, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFunctionalAITest, SpawnedPawns), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_SpawnedPawns_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_SpawnedPawns_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_PendingDelayedSpawns = { "PendingDelayedSpawns", nullptr, (EPropertyFlags)0x0020080000000014, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFunctionalAITest, PendingDelayedSpawns), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_PendingDelayedSpawns_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_PendingDelayedSpawns_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_OnAISpawned = { "OnAISpawned", nullptr, (EPropertyFlags)0x0020080010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFunctionalAITest, OnAISpawned), Z_Construct_UDelegateFunction_FunctionalTesting_FunctionalTestAISpawned__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_OnAISpawned_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_OnAISpawned_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_OnAllAISPawned = { "OnAllAISPawned", nullptr, (EPropertyFlags)0x0020080010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFunctionalAITest, OnAllAISPawned), Z_Construct_UDelegateFunction_FunctionalTesting_FunctionalTestEventSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_OnAllAISPawned_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFunctionalAITest_Statics::NewProp_OnAllAISPawned_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFunctionalAITest, 2956419659);
