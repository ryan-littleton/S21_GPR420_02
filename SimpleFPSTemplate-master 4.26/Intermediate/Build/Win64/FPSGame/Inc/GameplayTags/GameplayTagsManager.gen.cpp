...
static struct FScriptStruct_GameplayTags_StaticRegisterNativesFGameplayTagTableRow
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGameplayTagsManager_Statics::NewProp_TagSources_MetaData[] = {
		{ "Comment", "/** List of gameplay tag sources */" },
		{ "ModuleRelativePath", "Classes/GameplayTagsManager.h" },
		{ "ToolTip", "List of gameplay tag sources" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameplayTagsManager_Statics::NewProp_TagSources = { "TagSources", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameplayTagsManager, TagSources), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGameplayTagsManager_Statics::NewProp_TagSources_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayTagsManager_Statics::NewProp_TagSources_MetaData)) };
	...
	IMPLEMENT_CLASS(UGameplayTagsManager, 3743982698);
