...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ChaosCloth_EChaosWeightMapTarget_Hash() { return 3065715009U; }
	UEnum* Z_Construct_UEnum_ChaosCloth_EChaosWeightMapTarget()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EChaosWeightMapTarget::AnimDriveMultiplier", (int64)EChaosWeightMapTarget::AnimDriveMultiplier },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "AnimDriveMultiplier.Name", "EChaosWeightMapTarget::AnimDriveMultiplier" },
