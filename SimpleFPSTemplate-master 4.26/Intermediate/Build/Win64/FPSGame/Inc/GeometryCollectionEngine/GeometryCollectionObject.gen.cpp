...
static struct FScriptStruct_GeometryCollectionEngine_StaticRegisterNativesFGeometryCollectionSource
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("GeometryCollectionSource")),new UScriptStruct::TCppStructOps<FGeometryCollectionSource>);
	}
	...
	IMPLEMENT_CLASS(UGeometryCollection, 1706940190);
