...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneColorTrack_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneColorTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneColorTrack, IMovieSceneTrackTemplateProducer), false },
		};
	...
	IMPLEMENT_CLASS(UMovieSceneColorTrack, 3206053096);
