...
static_assert(std::is_polymorphic<FMovieSceneCameraShakeSectionTemplate>() == std::is_polymorphic<FMovieSceneAdditiveCameraAnimationTemplate>(), "USTRUCT FMovieSceneCameraShakeSectionTemplate cannot be polymorphic unless super FMovieSceneAdditiveCameraAnimationTemplate is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneCameraShakeSectionTemplate
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneCameraShakeSectionTemplate_Hash() { return 2687210116U; }

static_assert(std::is_polymorphic<FMovieSceneCameraAnimSectionTemplate>() == std::is_polymorphic<FMovieSceneAdditiveCameraAnimationTemplate>(), "USTRUCT FMovieSceneCameraAnimSectionTemplate cannot be polymorphic unless super FMovieSceneAdditiveCameraAnimationTemplate is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneCameraAnimSectionTemplate
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneCameraAnimSectionTemplate_Hash() { return 1513970930U; }

static_assert(std::is_polymorphic<FMovieSceneAdditiveCameraAnimationTemplate>() == std::is_polymorphic<FMovieSceneEvalTemplate>(), "USTRUCT FMovieSceneAdditiveCameraAnimationTemplate cannot be polymorphic unless super FMovieSceneEvalTemplate is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneAdditiveCameraAnimationTemplate
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneAdditiveCameraAnimationTemplate_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** Generic section template for any additive camera animation effects */" },
		{ "ModuleRelativePath", "Private/Evaluation/MovieSceneCameraAnimTemplate.h" },
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneAdditiveCameraAnimationTemplate_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000005),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneAdditiveCameraAnimationTemplate_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneAdditiveCameraAnimationTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneAdditiveCameraAnimationTemplate_Hash() { return 2816180270U; }
