...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneByteTrack_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneByteTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneByteTrack, IMovieSceneTrackTemplateProducer), false },
		};
	...
	IMPLEMENT_CLASS(UMovieSceneByteTrack, 936177439);
