...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneCameraShakeSectionData
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneCameraShakeSectionData_Hash() { return 2486480638U; }
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UMovieSceneCameraShakeSection_Statics::NewProp_ShakeClass = { "ShakeClass", nullptr, (EPropertyFlags)0x0014000020000000, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCameraShakeSection, ShakeClass_DEPRECATED), Z_Construct_UClass_UMatineeCameraShake_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCameraShakeSection_Statics::NewProp_ShakeClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraShakeSection_Statics::NewProp_ShakeClass_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieSceneCameraShakeSection, 521756701);
