...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraMeshMaterialOverride
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraMeshMaterialOverride_Hash() { return 101048378U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_PivotOffset = { "PivotOffset", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraMeshRendererProperties, PivotOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_PivotOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_PivotOffset_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_PivotOffsetSpace = { "PivotOffsetSpace", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraMeshRendererProperties, PivotOffsetSpace), Z_Construct_UEnum_Niagara_ENiagaraMeshPivotOffsetSpace, METADATA_PARAMS(Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_PivotOffsetSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_PivotOffsetSpace_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNiagaraMeshRendererProperties, 542334436);
