...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode_Hash() { return 1202758659U; }
	UEnum* Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ScaledUniformly.Comment", "/** Ribbon UVs will be scaled to the 0-1 range and distributed evenly across uv segments regardless of segment length. */" },
				{ "ScaledUniformly.Name", "ENiagaraRibbonUVDistributionMode::ScaledUniformly" },
				{ "ScaledUniformly.ToolTip", "Ribbon UVs will be scaled to the 0-1 range and distributed evenly across uv segments regardless of segment length." },
				{ "ScaledUsingRibbonSegmentLength.Comment", "/** Ribbon UVs will be scaled to the 0-1 range and will be distributed along the ribbon segments based on their length, i.e. short segments get less UV range and large segments get more. */" },
				{ "ScaledUsingRibbonSegmentLength.Name", "ENiagaraRibbonUVDistributionMode::ScaledUsingRibbonSegmentLength" },
				{ "ScaledUsingRibbonSegmentLength.ToolTip", "Ribbon UVs will be scaled to the 0-1 range and will be distributed along the ribbon segments based on their length, i.e. short segments get less UV range and large segments get more." },
				{ "TiledOverRibbonLength.Comment", "/** Ribbon UVs will be tiled along the length of the ribbon based on segment length and the Tile Over Length Scale value. NOTE: This is not equivalent to distance tiling which tiles over owner distance traveled, this requires per particle U override values and can be setup with modules. */" },
				{ "TiledOverRibbonLength.Name", "ENiagaraRibbonUVDistributionMode::TiledOverRibbonLength" },
				{ "TiledOverRibbonLength.ToolTip", "Ribbon UVs will be tiled along the length of the ribbon based on segment length and the Tile Over Length Scale value. NOTE: This is not equivalent to distance tiling which tiles over owner distance traveled, this requires per particle U override values and can be setup with modules." },
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonUVSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("NiagaraRibbonUVSettings")),new UScriptStruct::TCppStructOps<FNiagaraRibbonUVSettings>);
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode_MetaData[] = {
		{ "Category", "UVs" },
		{ "Comment", "/** Specifies how UVs behave at the leading edge of the ribbon where particles are being added. */" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Specifies how UVs behave at the leading edge of the ribbon where particles are being added." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode_MetaData[] = {
		{ "Category", "UVs" },
		{ "Comment", "/** Specifies how UVs behave at the trailing edge of the ribbon where particles are being removed. */" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Specifies how UVs behave at the trailing edge of the ribbon where particles are being removed." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TilingLength_MetaData[] = {
		{ "Category", "UVs" },
		{ "Comment", "/** Specifies the length in world units to use when tiling UVs across the ribbon when using the tiled distribution mode. */" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Specifies the length in world units to use when tiling UVs across the ribbon when using the tiled distribution mode." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Offset_MetaData[] = {
		{ "Category", "UVs" },
		{ "Comment", "/** Specifies and additional offsets which are applied to the UV range */" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Specifies and additional offsets which are applied to the UV range" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Scale_MetaData[] = {
		{ "Category", "UVs" },
		{ "Comment", "/** Specifies and additional scalers which are applied to the UV range. */" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Specifies and additional scalers which are applied to the UV range." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride_MetaData[] = {
		{ "Category", "UVs" },
		{ "Comment", "/** Enables overriding overriding the U componenet with values read from the particles.  When enabled edge behavior and distribution are ignored. */" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Enables overriding overriding the U componenet with values read from the particles.  When enabled edge behavior and distribution are ignored." },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Hash() { return 3531756335U; }
	...
	IMPLEMENT_CLASS(UNiagaraRibbonRendererProperties, 2434328581);
