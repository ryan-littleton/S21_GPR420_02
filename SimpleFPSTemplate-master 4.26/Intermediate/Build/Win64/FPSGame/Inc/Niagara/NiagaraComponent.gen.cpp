...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraMaterialOverride
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("NiagaraMaterialOverride")),new UScriptStruct::TCppStructOps<FNiagaraMaterialOverride>);
	}
	...
	IMPLEMENT_CLASS(UNiagaraComponent, 1538279546);
