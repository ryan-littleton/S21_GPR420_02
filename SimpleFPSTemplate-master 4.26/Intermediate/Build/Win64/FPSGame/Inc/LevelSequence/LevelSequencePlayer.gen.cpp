...
static struct FScriptStruct_LevelSequence_StaticRegisterNativesFLevelSequenceCameraSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("LevelSequenceCameraSettings")),new UScriptStruct::TCppStructOps<FLevelSequenceCameraSettings>);
	}
...
static struct FScriptStruct_LevelSequence_StaticRegisterNativesFLevelSequenceSnapshotSettings
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULevelSequencePlayer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULevelSequencePlayer_CreateLevelSequencePlayer, "CreateLevelSequencePlayer" }, // 3978216257
		{ &Z_Construct_UFunction_ULevelSequencePlayer_GetActiveCameraComponent, "GetActiveCameraComponent" }, // 1881988632
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ULevelSequencePlayer, 472209974);
