...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFTestMovieSceneEvalTemplate
{
	...
	IMPLEMENT_CLASS(UTestMovieSceneTrack, 899407814);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSection, 2873190393);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSequence, 2408557314);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSubTrack, 797662246);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSubSection, 705663199);
