...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSectionEvalOptions
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneSection_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneSection_GetBlendType, "GetBlendType" }, // 3188894811
		{ &Z_Construct_UFunction_UMovieSceneSection_GetCompletionMode, "GetCompletionMode" }, // 4292812767
		{ &Z_Construct_UFunction_UMovieSceneSection_GetOverlapPriority, "GetOverlapPriority" }, // 1058657052
		{ &Z_Construct_UFunction_UMovieSceneSection_GetPostRollFrames, "GetPostRollFrames" }, // 1344838957
		{ &Z_Construct_UFunction_UMovieSceneSection_GetPreRollFrames, "GetPreRollFrames" }, // 405058518
		{ &Z_Construct_UFunction_UMovieSceneSection_GetRowIndex, "GetRowIndex" }, // 1396957879
		{ &Z_Construct_UFunction_UMovieSceneSection_IsActive, "IsActive" }, // 502760303
		{ &Z_Construct_UFunction_UMovieSceneSection_IsLocked, "IsLocked" }, // 1302840418
		{ &Z_Construct_UFunction_UMovieSceneSection_SetBlendType, "SetBlendType" }, // 23658778
		{ &Z_Construct_UFunction_UMovieSceneSection_SetCompletionMode, "SetCompletionMode" }, // 1775158324
		{ &Z_Construct_UFunction_UMovieSceneSection_SetIsActive, "SetIsActive" }, // 17956547
		{ &Z_Construct_UFunction_UMovieSceneSection_SetIsLocked, "SetIsLocked" }, // 3364618132
		{ &Z_Construct_UFunction_UMovieSceneSection_SetOverlapPriority, "SetOverlapPriority" }, // 3507610900
		{ &Z_Construct_UFunction_UMovieSceneSection_SetPostRollFrames, "SetPostRollFrames" }, // 241316921
		{ &Z_Construct_UFunction_UMovieSceneSection_SetPreRollFrames, "SetPreRollFrames" }, // 2993506861
		{ &Z_Construct_UFunction_UMovieSceneSection_SetRowIndex, "SetRowIndex" }, // 3596224288
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieSceneSection, 3063402298);
