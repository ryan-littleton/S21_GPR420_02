...
// End Cross Module References
	...
	struct Z_Construct_UClass_ALODActor_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ImpostersStaticMeshComponents_ValueProp;
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ImpostersStaticMeshComponents_Key_KeyProp;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ImpostersStaticMeshComponents_MetaData[];
#endif
		static const UE4CodeGen_Private::FMapPropertyParams NewProp_ImpostersStaticMeshComponents;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_ValueProp = { "ImpostersStaticMeshComponents", nullptr, (EPropertyFlags)0x00000000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UInstancedStaticMeshComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_Key_KeyProp = { "ImpostersStaticMeshComponents_Key", nullptr, (EPropertyFlags)0x00000000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_MetaData[] = {
		{ "Category", "LODActor" },
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents = { "ImpostersStaticMeshComponents", nullptr, (EPropertyFlags)0x0040008000020009, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALODActor, ImpostersStaticMeshComponents), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALODActor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALODActor_Statics::NewProp_ImpostersStaticMeshComponents,
	...
	IMPLEMENT_CLASS(ALODActor, 13549216);
