...
static struct FScriptStruct_Engine_StaticRegisterNativesFCustomDefine
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CustomDefine")),new UScriptStruct::TCppStructOps<FCustomDefine>);
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFCustomOutput
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CustomOutput")),new UScriptStruct::TCppStructOps<FCustomOutput>);
	}
