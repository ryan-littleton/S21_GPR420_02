...
static struct FScriptStruct_Engine_StaticRegisterNativesFTentDistribution
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USkyAtmosphereComponent_Statics::NewProp_AerialPerspectiveStartDepth_MetaData[] = {
		{ "Category", "Art Direction" },
		{ "ClampMin", "0.001000" },
		{ "Comment", "/** The distance (kiloneters) at which we start evaluating the aerial pespective. \n\x09Keeping this value a little away from the camera can help with performance: pixels not affected by the aerial perspective will have their computation skipped using early depth test.*/" },
		{ "ModuleRelativePath", "Classes/Components/SkyAtmosphereComponent.h" },
		{ "ToolTip", "The distance (kiloneters) at which we start evaluating the aerial pespective.\n      Keeping this value a little away from the camera can help with performance: pixels not affected by the aerial perspective will have their computation skipped using early depth test." },
		{ "UIMax", "10.000000" },
		{ "UIMin", "0.001000" },
	};
#endif
	...
	IMPLEMENT_CLASS(USkyAtmosphereComponent, 3168053335);
	...
	IMPLEMENT_CLASS(ASkyAtmosphere, 1447179077);
