...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ETextureLossyCompressionAmount_Hash() { return 4219927994U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_TextureCompressionSettings_Hash() { return 2565098394U; }
	UEnum* Z_Construct_UEnum_Engine_TextureCompressionSettings()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "TC_ReflectionCapture", (int64)TC_ReflectionCapture },
				{ "TC_MAX", (int64)TC_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "TC_ReflectionCapture.DisplayName", "Default (DXT5)" },
				{ "TC_ReflectionCapture.Name", "TC_ReflectionCapture" },
...
static struct FScriptStruct_Engine_StaticRegisterNativesFTextureFormatSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TextureFormatSettings")),new UScriptStruct::TCppStructOps<FTextureFormatSettings>);
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFTextureSourceBlock
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TextureSourceBlock")),new UScriptStruct::TCppStructOps<FTextureSourceBlock>);
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTexture_Statics::NewProp_MaxTextureSize_MetaData[] = {
		{ "Category", "Compression" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** The maximum resolution for generated textures. A value of 0 means the maximum size for the format on each platform, except HDR long/lat cubemaps, which default to a resolution of 512. */" },
	...
	IMPLEMENT_CLASS(UTexture, 1027280485);
