...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDirectionalLightComponent_Statics::NewProp_bPerPixelAtmosphereTransmittance_MetaData[] = {
		{ "Category", "AtmosphereAndCloud" },
		{ "Comment", "/**\n\x09 * Whether to apply atmosphere transmittance per pixel on opaque meshes, instead of using the light global transmittance.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Components/DirectionalLightComponent.h" },
	...
	IMPLEMENT_CLASS(UDirectionalLightComponent, 2140914790);
