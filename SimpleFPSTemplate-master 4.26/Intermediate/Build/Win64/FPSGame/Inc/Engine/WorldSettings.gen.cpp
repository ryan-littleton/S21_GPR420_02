...
static struct FScriptStruct_Engine_StaticRegisterNativesFLightmassWorldInfoSettings
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWorldSettings_Statics::NewProp_MonoCullingDistance_MetaData[] = {
		{ "Category", "VR" },
		{ "Comment", "/** Distance from the player after which content will be rendered in mono if monoscopic far field rendering is activated */" },
		{ "ModuleRelativePath", "Classes/GameFramework/WorldSettings.h" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AWorldSettings_Statics::NewProp_MonoCullingDistance = { "MonoCullingDistance", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AWorldSettings, MonoCullingDistance), METADATA_PARAMS(Z_Construct_UClass_AWorldSettings_Statics::NewProp_MonoCullingDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AWorldSettings_Statics::NewProp_MonoCullingDistance_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AWorldSettings, 33111891);
