...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioComponentParam
{
	...
	DEFINE_FUNCTION(UAudioComponent::execSetAudioBusSendPostEffect)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetAudioBusSendPostEffect(Z_Param_AudioBus,Z_Param_SourceBusSendLevel);
		P_NATIVE_END;
	}
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::NewProp_SourceBusSendLevel = { "SourceBusSendLevel", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventSetAudioBusSendPostEffect_Parms, SourceBusSendLevel), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::NewProp_SourceBusSendLevel,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Sets how much audio the sound should send to the given Audio Bus (POST Source Effects).\n\x09\x09if the Audio Bus Send doesn't already exist, it will be added to the overrides on the active sound */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Sets how much audio the sound should send to the given Audio Bus (PRE Source Effects).\n\x09if the Bus Send doesn't already exist, it will be added to the overrides on the active sound */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAudioComponent_AdjustVolume, "AdjustVolume" }, // 2876651413
		{ &Z_Construct_UFunction_UAudioComponent_BP_GetAttenuationSettingsToApply, "BP_GetAttenuationSettingsToApply" }, // 1692666751
		{ &Z_Construct_UFunction_UAudioComponent_FadeIn, "FadeIn" }, // 2695048595
		{ &Z_Construct_UFunction_UAudioComponent_FadeOut, "FadeOut" }, // 1898177665
		{ &Z_Construct_UFunction_UAudioComponent_GetCookedEnvelopeData, "GetCookedEnvelopeData" }, // 3895010073
		...
		{ &Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect, "SetAudioBusSendPostEffect" }, // 3604565041
		{ &Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect, "SetAudioBusSendPreEffect" }, // 3253514350
		{ &Z_Construct_UFunction_UAudioComponent_SetBoolParameter, "SetBoolParameter" }, // 1742557256
		{ &Z_Construct_UFunction_UAudioComponent_SetFloatParameter, "SetFloatParameter" }, // 999610571
		{ &Z_Construct_UFunction_UAudioComponent_SetIntParameter, "SetIntParameter" }, // 2667386624
		...
		{ &Z_Construct_UFunction_UAudioComponent_SetSourceBusSendPostEffect, "SetSourceBusSendPostEffect" }, // 19885210
		{ &Z_Construct_UFunction_UAudioComponent_SetSourceBusSendPreEffect, "SetSourceBusSendPreEffect" }, // 487113500
		{ &Z_Construct_UFunction_UAudioComponent_SetSubmixSend, "SetSubmixSend" }, // 1499338116
		...
		{ &Z_Construct_UFunction_UAudioComponent_SetWaveParameter, "SetWaveParameter" }, // 815251164
		{ &Z_Construct_UFunction_UAudioComponent_Stop, "Stop" }, // 3452359505
		{ &Z_Construct_UFunction_UAudioComponent_StopDelayed, "StopDelayed" }, // 2302133630
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioPlayStateChanged_MetaData[] = {
		{ "Comment", "/** Called when PlayState changes */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Called when PlayState changes" },
	};
#endif
	...
	IMPLEMENT_CLASS(UAudioComponent, 2815281015);
