...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Magnitudes_MetaData[];
#endif
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes_Inner = { "Magnitudes", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes = { "Magnitudes", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventOnSubmixSpectralAnalysis_Parms, Magnitudes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::NewProp_Magnitudes,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, nullptr, "OnSubmixSpectralAnalysis__DelegateSignature", nullptr, nullptr, sizeof(_Script_Engine_eventOnSubmixSpectralAnalysis_Parms), Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysis__DelegateSignature_Statics::FuncParams);
		}
	...
	static UEnum* EGainParamMode_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Engine_EGainParamMode, Z_Construct_UPackage__Script_Engine(), TEXT("EGainParamMode"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EGainParamMode(EGainParamMode_StaticEnum, TEXT("/Script/Engine"), TEXT("EGainParamMode"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Engine_EGainParamMode_Hash() { return 4169382794U; }
	UEnum* Z_Construct_UEnum_Engine_EGainParamMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EGainParamMode"), 0, Get_Z_Construct_UEnum_Engine_EGainParamMode_Hash(), false);
#else
	...
	static UEnum* EAudioSpectrumType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAudioSpectrumType, Z_Construct_UPackage__Script_Engine(), TEXT("EAudioSpectrumType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EAudioSpectrumType(EAudioSpectrumType_StaticEnum, TEXT("/Script/Engine"), TEXT("EAudioSpectrumType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Engine_EAudioSpectrumType_Hash() { return 54320886U; }
	UEnum* Z_Construct_UEnum_Engine_EAudioSpectrumType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EAudioSpectrumType"), 0, Get_Z_Construct_UEnum_Engine_EAudioSpectrumType_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EFFTWindowType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Engine_EFFTWindowType, Z_Construct_UPackage__Script_Engine(), TEXT("EFFTWindowType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFFTWindowType(EFFTWindowType_StaticEnum, TEXT("/Script/Engine"), TEXT("EFFTWindowType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Engine_EFFTWindowType_Hash() { return 1361832691U; }
	UEnum* Z_Construct_UEnum_Engine_EFFTWindowType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EFFTWindowType"), 0, Get_Z_Construct_UEnum_Engine_EFFTWindowType_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EFFTPeakInterpolationMethod_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Engine_EFFTPeakInterpolationMethod, Z_Construct_UPackage__Script_Engine(), TEXT("EFFTPeakInterpolationMethod"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFFTPeakInterpolationMethod(EFFTPeakInterpolationMethod_StaticEnum, TEXT("/Script/Engine"), TEXT("EFFTPeakInterpolationMethod"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Engine_EFFTPeakInterpolationMethod_Hash() { return 2270821581U; }
	UEnum* Z_Construct_UEnum_Engine_EFFTPeakInterpolationMethod()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EFFTPeakInterpolationMethod"), 0, Get_Z_Construct_UEnum_Engine_EFFTPeakInterpolationMethod_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EFFTSize_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Engine_EFFTSize, Z_Construct_UPackage__Script_Engine(), TEXT("EFFTSize"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFFTSize(EFFTSize_StaticEnum, TEXT("/Script/Engine"), TEXT("EFFTSize"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Engine_EFFTSize_Hash() { return 2036768411U; }
	UEnum* Z_Construct_UEnum_Engine_EFFTSize()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EFFTSize"), 0, Get_Z_Construct_UEnum_Engine_EFFTSize_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	IMPLEMENT_CLASS(USoundSubmixBase, 1358256869);
	...
	IMPLEMENT_CLASS(USoundSubmixWithParentBase, 4264452621);
...
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_WorldContextObject;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_InBandSettings_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InBandSettings_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_InBandSettings;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnSubmixSpectralAnalysisBP_MetaData[];
#endif
		static const UE4CodeGen_Private::FDelegatePropertyParams NewProp_OnSubmixSpectralAnalysisBP;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_UpdateRate;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DecibelNoiseFloor;
		static void NewProp_bDoNormalize_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDoNormalize;
		static void NewProp_bDoAutoRange_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDoAutoRange;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AutoRangeAttackTime;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AutoRangeReleaseTime;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings_Inner = { "InBandSettings", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSoundSubmixSpectralAnalysisBandSettings, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings = { "InBandSettings", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, InBandSettings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP = { "OnSubmixSpectralAnalysisBP", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, OnSubmixSpectralAnalysisBP), Z_Construct_UDelegateFunction_Engine_OnSubmixSpectralAnalysisBP__DelegateSignature, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP_MetaData)) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_UpdateRate = { "UpdateRate", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, UpdateRate), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_DecibelNoiseFloor = { "DecibelNoiseFloor", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, DecibelNoiseFloor), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_bDoNormalize = { "bDoNormalize", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms), &Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_bDoNormalize_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_bDoAutoRange = { "bDoAutoRange", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms), &Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_bDoAutoRange_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_AutoRangeAttackTime = { "AutoRangeAttackTime", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, AutoRangeAttackTime), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_AutoRangeReleaseTime = { "AutoRangeReleaseTime", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms, AutoRangeReleaseTime), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_InBandSettings,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_UpdateRate,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_DecibelNoiseFloor,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_bDoNormalize,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_bDoAutoRange,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_AutoRangeAttackTime,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::NewProp_AutoRangeReleaseTime,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::Function_MetaDataParams[] = {
		{ "AdvancedDisplay", "3" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USoundSubmix, nullptr, "AddSpectralAnalysisDelegate", nullptr, nullptr, sizeof(SoundSubmix_eventAddSpectralAnalysisDelegate_Parms), Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventRemoveSpectralAnalysisDelegate_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_WorldContextObject,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::NewProp_OnSubmixSpectralAnalysisBP,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Spectrum" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USoundSubmix, nullptr, "RemoveSpectralAnalysisDelegate", nullptr, nullptr, sizeof(SoundSubmix_eventRemoveSpectralAnalysisDelegate_Parms), Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStartSpectralAnalysis_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WorldContextObject_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_FFTSize_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_FFTSize = { "FFTSize", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStartSpectralAnalysis_Parms, FFTSize), Z_Construct_UEnum_Engine_EFFTSize, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_InterpolationMethod_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_InterpolationMethod = { "InterpolationMethod", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStartSpectralAnalysis_Parms, InterpolationMethod), Z_Construct_UEnum_Engine_EFFTPeakInterpolationMethod, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WindowType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WindowType = { "WindowType", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStartSpectralAnalysis_Parms, WindowType), Z_Construct_UEnum_Engine_EFFTWindowType, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_HopSize = { "HopSize", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStartSpectralAnalysis_Parms, HopSize), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_SpectrumType = { "SpectrumType", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStartSpectralAnalysis_Parms, SpectrumType), Z_Construct_UEnum_Engine_EAudioSpectrumType, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WorldContextObject,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_FFTSize_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_FFTSize,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_InterpolationMethod_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_InterpolationMethod,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WindowType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_WindowType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_HopSize,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_SpectrumType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::NewProp_SpectrumType,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::Function_MetaDataParams[] = {
		{ "AdvancedDisplay", "1" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USoundSubmix, nullptr, "StartSpectralAnalysis", nullptr, nullptr, sizeof(SoundSubmix_eventStartSpectralAnalysis_Parms), Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundSubmix_eventStopSpectralAnalysis_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::NewProp_WorldContextObject_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::NewProp_WorldContextObject,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::Function_MetaDataParams[] = {
		{ "AdvancedDisplay", "1" },
		{ "Category", "Audio|Analysis" },
		{ "Comment", "/** Start spectrum analysis of the audio output. */" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USoundSubmix, nullptr, "StopSpectralAnalysis", nullptr, nullptr, sizeof(SoundSubmix_eventStopSpectralAnalysis_Parms), Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UClass_USoundSubmix_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_GainMode_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GainMode_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_GainMode;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OutputVolumeDB_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_OutputVolumeDB;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WetLevelDB_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_WetLevelDB;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DryLevelDB_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DryLevelDB;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USoundSubmix_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USoundSubmix_AddEnvelopeFollowerDelegate, "AddEnvelopeFollowerDelegate" }, // 266382525
		{ &Z_Construct_UFunction_USoundSubmix_AddSpectralAnalysisDelegate, "AddSpectralAnalysisDelegate" }, // 4069291542
		{ &Z_Construct_UFunction_USoundSubmix_RemoveSpectralAnalysisDelegate, "RemoveSpectralAnalysisDelegate" }, // 1133753236
		{ &Z_Construct_UFunction_USoundSubmix_SetSubmixOutputVolume, "SetSubmixOutputVolume" }, // 3222386405
		{ &Z_Construct_UFunction_USoundSubmix_StartEnvelopeFollowing, "StartEnvelopeFollowing" }, // 1757938499
		{ &Z_Construct_UFunction_USoundSubmix_StartRecordingOutput, "StartRecordingOutput" }, // 1558339290
		{ &Z_Construct_UFunction_USoundSubmix_StartSpectralAnalysis, "StartSpectralAnalysis" }, // 3970239631
		{ &Z_Construct_UFunction_USoundSubmix_StopEnvelopeFollowing, "StopEnvelopeFollowing" }, // 740899491
		{ &Z_Construct_UFunction_USoundSubmix_StopRecordingOutput, "StopRecordingOutput" }, // 641806657
		{ &Z_Construct_UFunction_USoundSubmix_StopSpectralAnalysis, "StopSpectralAnalysis" }, // 1094103076
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode_MetaData[] = {
		{ "Category", "SubmixLevel" },
		{ "Comment", "/** Whether to treat submix gain levels as linear or decibel values. */" },
		{ "InlineCategoryProperty", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "Whether to treat submix gain levels as linear or decibel values." },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode = { "GainMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, GainMode), Z_Construct_UEnum_Engine_EGainParamMode, METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolume_MetaData[] = {
		...
		{ "EditCondition", "GainMode == EGainParamMode::Linear" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevel_MetaData[] = {
		{ "Category", "SubmixLevel" },
		{ "ClampMax", "1.0" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** The wet level of the submix. Applied after submix effects and analysis are performed. */" },
		{ "DisplayName", "Wet Level" },
		{ "EditCondition", "GainMode == EGainParamMode::Linear" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "The wet level of the submix. Applied after submix effects and analysis are performed." },
		{ "UIMax", "1.0" },
		{ "UIMin", "0.0" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevel = { "WetLevel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, WetLevel), METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevel_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevel_MetaData[] = {
		{ "Category", "SubmixLevel" },
		{ "ClampMax", "1.0" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** The dry level of the submix. Applied before submix effects and analysis are performed. */" },
		{ "DisplayName", "Dry Level" },
		{ "EditCondition", "GainMode == EGainParamMode::Linear" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "The dry level of the submix. Applied before submix effects and analysis are performed." },
		{ "UIMax", "1.0" },
		{ "UIMin", "0.0" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevel = { "DryLevel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, DryLevel), METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevel_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeDB_MetaData[] = {
		{ "Category", "SubmixLevel" },
		{ "ClampMax", "0.0" },
		{ "ClampMin", "-120.0" },
		{ "Comment", "/** The output volume of the submix (in dB). */" },
		{ "DisplayName", "Output Volume (dB)" },
		{ "EditCondition", "GainMode == EGainParamMode::Decibels" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "The output volume of the submix (in dB)." },
		{ "UIMax", "0.0" },
		{ "UIMin", "-60.0" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeDB = { "OutputVolumeDB", nullptr, (EPropertyFlags)0x0010000800000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, OutputVolumeDB), METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeDB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeDB_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelDB_MetaData[] = {
		{ "Category", "SubmixLevel" },
		{ "ClampMax", "0.0" },
		{ "ClampMin", "-120.0" },
		{ "Comment", "/** The wet level of the submix  (in dB). Applied after submix effects and analysis are performed. */" },
		{ "DisplayName", "Wet Level (dB)" },
		{ "EditCondition", "GainMode == EGainParamMode::Decibels" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "The wet level of the submix  (in dB). Applied after submix effects and analysis are performed." },
		{ "UIMax", "0.0" },
		{ "UIMin", "-60.0" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelDB = { "WetLevelDB", nullptr, (EPropertyFlags)0x0010000800000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, WetLevelDB), METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelDB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelDB_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelDB_MetaData[] = {
		{ "Category", "SubmixLevel" },
		{ "ClampMax", "0.0" },
		{ "ClampMin", "-120.0" },
		{ "Comment", "/** The dry level of the submix  (in dB)s. Applied before submix effects and analysis are performed. */" },
		{ "DisplayName", "Dry Level (dB)" },
		{ "EditCondition", "GainMode == EGainParamMode::Decibels" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Classes/Sound/SoundSubmix.h" },
		{ "ToolTip", "The dry level of the submix  (in dB)s. Applied before submix effects and analysis are performed." },
		{ "UIMax", "0.0" },
		{ "UIMin", "-60.0" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelDB = { "DryLevelDB", nullptr, (EPropertyFlags)0x0010000800000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSubmix, DryLevelDB), METADATA_PARAMS(Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelDB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelDB_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USoundSubmix_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_GainMode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolume,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevel,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevel,
#if WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_OutputVolumeDB,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_WetLevelDB,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USoundSubmix_Statics::NewProp_DryLevelDB,
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(USoundSubmix, 2767864303);
	...
	IMPLEMENT_CLASS(USoundfieldSubmix, 1313017016);
	...
	IMPLEMENT_CLASS(UEndpointSubmix, 1703200804);
	...
	IMPLEMENT_CLASS(USoundfieldEndpointSubmix, 22585519);
