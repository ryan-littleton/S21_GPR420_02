...
static struct FScriptStruct_Engine_StaticRegisterNativesFVertexOffsetUsage
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VertexOffsetUsage")),new UScriptStruct::TCppStructOps<FVertexOffsetUsage>);
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSkelMeshSkinWeightInfo
{
	...
	IMPLEMENT_CLASS(USkinnedMeshComponent, 284976584);
