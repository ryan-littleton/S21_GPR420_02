...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticMeshSourceModel
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FStaticMeshSourceModel_Hash() { return 2493515400U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticMeshOptimizationSettings
{
	...
	DEFINE_FUNCTION(UStaticMesh::execSetLODGroup)
	{
		P_GET_PROPERTY(FNameProperty,Z_Param_NewGroup);
		P_GET_UBOOL(Z_Param_bRebuildImmediately);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetLODGroup(Z_Param_NewGroup,Z_Param_bRebuildImmediately);
		P_NATIVE_END;
	}
#endif //WITH_EDITOR
...
#if WITH_EDITOR
			{ "SetLODGroup", &UStaticMesh::execSetLODGroup },
...
#if WITH_EDITOR
	struct Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics
	{
		struct StaticMesh_eventSetLODGroup_Parms
		{
			FName NewGroup;
			bool bRebuildImmediately;
		};
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_NewGroup;
		static void NewProp_bRebuildImmediately_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bRebuildImmediately;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::NewProp_NewGroup = { "NewGroup", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(StaticMesh_eventSetLODGroup_Parms, NewGroup), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::NewProp_bRebuildImmediately_SetBit(void* Obj)
	{
		((StaticMesh_eventSetLODGroup_Parms*)Obj)->bRebuildImmediately = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::NewProp_bRebuildImmediately = { "bRebuildImmediately", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(StaticMesh_eventSetLODGroup_Parms), &Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::NewProp_bRebuildImmediately_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::NewProp_NewGroup,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::NewProp_bRebuildImmediately,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::Function_MetaDataParams[] = {
		{ "Category", "StaticMesh" },
		{ "CPP_Default_bRebuildImmediately", "true" },
		{ "ModuleRelativePath", "Classes/Engine/StaticMesh.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UStaticMesh, nullptr, "SetLODGroup", nullptr, nullptr, sizeof(StaticMesh_eventSetLODGroup_Parms), Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x24020403, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UStaticMesh_SetLODGroup()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UStaticMesh_SetLODGroup_Statics::FuncParams);
		}
		return ReturnFunction;
	}
#endif //WITH_EDITOR
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UStaticMesh_SetLODGroup, "SetLODGroup" }, // 1351247002
#endif //WITH_EDITOR
#if WITH_EDITOR
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UStaticMesh_Statics::NewProp_StaticMaterials = { "StaticMaterials", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMesh, StaticMaterials), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UStaticMesh_Statics::NewProp_StaticMaterials_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMesh_Statics::NewProp_StaticMaterials_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStaticMesh_Statics::NewProp_bIsBuiltAtRuntime_MetaData[] = {
		{ "Comment", "/**\n\x09 * If true, StaticMesh has been built at runtime\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Engine/StaticMesh.h" },
		{ "ToolTip", "If true, StaticMesh has been built at runtime" },
	};
#endif
	...
	IMPLEMENT_CLASS(UStaticMesh, 1749924607);
